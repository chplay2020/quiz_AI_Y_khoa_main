...
class DocumentProcessor:
    ...
    def _clean_text(self, text: str) -> str:
        ...
        # Remove common watermarks / noise found in some Vietnamese medical PDFs
        text = re.sub(r'(?i)\\byhocdata\\.com\\b', ' ', text)
        text = re.sub(r'(?i)\\bwww\\.yhocdata\\.com\\b', ' ', text)
        text = re.sub(r'(?i)\\byhocdata\\b', ' ', text)
